...
export const PLAYER_LIGHT_GROWTH_FACTOR     = 0.1 * LIGHT_MAP_PRECISION;
export const PLAYER_LUMINOSITY_START         = 5 * LIGHT_MAP_PRECISION;
export const PLAYER_LUMINOSITY_MAX_START     = 10 * LIGHT_MAP_PRECISION;
