...
export const LIGHT_PARTICLE_FLICKER     = LIGHT_MAP_PRECISION;
...
export const LIGHT_WISP_FLICKER         = LIGHT_MAP_PRECISION * 0.5;
...
export const LIGHT_WISP_CHANGE_MIN      = 2.5 * LIGHT_MAP_PRECISION;
export const LIGHT_WISP_CHANGE_MAX      = 12 * LIGHT_MAP_PRECISION;
...
export const LIGHT_HINTLIGHT_BRIGHTNESS = 5 * LIGHT_MAP_PRECISION;
export const LIGHT_HINTLIGHT_SPEED      = 1;

export const LIGHT_SENDLIGHT_BRIGHTNESS = 10 * LIGHT_MAP_PRECISION;
...
export const PLAYER_LIGHT_MAX_BRIGHTNESS_DOT    = 5 * LIGHT_MAP_PRECISION;
export const PLAYER_LIGHT_MAX_BRIGHTNESS_BOX    = 5 * LIGHT_MAP_PRECISION;
export const PLAYER_LIGHT_MAX_BRIGHTNESS_SNAKE  = 4 * LIGHT_MAP_PRECISION;
export const PLAYER_LIGHT_RESERVES_MAX_DOT      = 20 * LIGHT_MAP_PRECISION;
export const PLAYER_LIGHT_RESERVES_MAX_BOX      = 20 * LIGHT_MAP_PRECISION;
export const PLAYER_LIGHT_RESERVES_MAX_SNAKE    = 15 * LIGHT_MAP_PRECISION;
